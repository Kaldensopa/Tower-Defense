...
shot_fxback = pg.mixer.Sound('assets/audio/Starstruck.wav')
shot_fxback.set_volume(0.5)
shot_fxback.play()
...
def create_turret(mouse_pos):
  ...
  if world.tile_map[mouse_tile_num] == 7:
    ...
    if space_is_free == True:
      new_turret = Turret(turret_spritesheets, mouse_tile_x, mouse_tile_y, shot_fx,shot_fxback)
